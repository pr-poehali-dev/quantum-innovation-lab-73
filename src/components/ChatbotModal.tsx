      ...
      >
        ...
        <div className="h-[80vh] w-full overflow-hidden rounded-lg flex items-center justify-center bg-gray-900">
          <div className="text-center text-white p-8 max-w-md">
            ...
            <p className="text-2xl font-bold mb-3">ИИ-ассистент PatentScope</p>
            <p className="text-gray-400 mb-4">
              Задайте любой вопрос о патентной активности в России: тренды по отраслям,
              прогнозы роста, анализ конкурентов.
            </p>
            <p className="text-blue-400 text-sm mt-6">Скоро будет доступен — оставьте заявку в разделе «Контакты»</p>
          </div>
        </div>
      </div>
    </div>
